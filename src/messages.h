...
#define MESSAGEMAIN_post_message_body 		"<b>Сообщение:</b> <FONT class=cl>(<A HREF=\"" MY_CGI_URL \
	"?help\" STYLE=\"text-decoration:underline;\" target=_blank>Как добавить форматирование, картинки, и т.д. в ваше сообщение</A>)</FONT>"
...
#define MESSAGEMAIN_privatemsg_date			"Отправлено:"
...
#define MESSAGEMAIN_search_howtouse		"Введение в правила использования поиска.<BR>Поиск ведется по <U><B>частичным</B></U> кускам слов <B>(не меньше трех символов!)</B> содержащимся в " \
...
#define MESSAGEHEAD_configure_msgslast		" посланные в течение последних "
#define MESSAGEHEAD_configure_lastnum		" последних "
#define MESSAGEHEAD_configure_lastnum2		" ветвей "
...
#define WWWCONF_FULL_NAME "Форум"
...
// for STABLE_TITLE = 0
// board name prefix
#define TITLE_WWWConfBegining		"Форум"
...
/***************************** welcome messages **************************/
#define WELCOME_CONFERENCE_HEADER	"<B>Вход:</B> "//"<U><B>Вселенское ЗЛО:</B></U> "	// :))) // namek ponyat :)
//#define ZLO ""

#define MESSAGEMAIN_ACTIVITY_STATVIEW	"Активность: <B><FONT COLOR=BLUE>%ld</FONT> <FONT COLOR=#229911>%ld</FONT></B>" \
...
#define MESSAGEMAIN_WELCOME_NEWTHREADS_TEXT		"новых потоков(сообщений): %ld(%ld) из %ld"
...
#define MESSAGEMAIN_WELCOME_YOURSETTINGS	"ваши текущие темы"
...
#define TAG_MSG_CLOSED_THREAD	"<EM><SMALL><font color=#900000>(закрыто) </font></EM></SMALL>"
#define TAG_MSG_ROLLED_THREAD	"<EM><font color=#900000>Cвернуто: </font></EM>"
#define TAG_ONLYHEADERS_POSTCNT "%s%s<EM>(ответов: <b>%d</b>)</EM>%s"
#define TAG_ONLYHEADERS_POSTCNT_MARKNEW	"%s%s<EM>(ответов: <b>%d</b>, новых: <b>%d</b>," \
								" последний ответ: <A STYLE=\"text-decoration:underline;\" " \
								"HREF=%s?read=%ld>от %s, %s</A>)</EM>%s"
...
#define DESIGN_INDEX_WELCOME_STRING1	"  %s %ld %s, всего %d"
...
"<area shape=\"rect\" coords=\"669,11,700,39\" href=\"#up\" alt=\"Наверх\">" \
...
#define TEXT_BOTTOMBANNER_SHORT "" /* "<P></P><CENTER><SMALL>Конференция основана на движке " \
"<A STYLE=\"text-decoration:underline;\" href=\"http://2ka.mipt.ru/~www/\" TARGET=\"_blank\">WWWConf " VERSION \
"</A>, поддерживается и модерируется группой <a STYLE=\"text-decoration:underline;\" " \
	"href=\"http://board.rt.mipt.ru/authors.html\">энтузиастов</a>.</SMALL></CENTER></BODY></HTML>"*/
